...
#define HAVE_CAMLIB_H 1		/* if we may include camlib.h for CAM SCSI transport definitions */
...
#define HAVE_BSD_SETPGRP 1		/* setpgrp() in libc is BSD-4.2 compliant */
...
#define HAVE_WAIT6 1		/* wait6() is present in libc */
...
/* #undef HAVE_FTIME */		/* ftime() is present in libc */
...
#define HAVE_LIBICONV 1		/* libiconv() is present in libiconv */
#define HAVE_LIBICONV_OPEN 1	/* libiconv_open() is present in liiconv */
#define HAVE_LIBICONV_CLOSE 1	/* libiconv_close() is present in libiconv */
...
#define HAVE_LPATHCONF 1		/* lpathconf() is present in libc */
...
/* #undef HAVE_GETTEXT_IN_LIBC */	/* whether gettext() is in libc (needs no -lintl) */
...
#define DEV_MINOR_BITS 40		/* # if bits needed to hold minor device number */
...
/* #undef	HAVE_TYPE_SIGINFO_T */	/* if <sys/wait.h> defines siginfo_t */
...
#define HAVE_ACL_TO_TEXT_NP 1	/* acl_to_text_np() function */
#define HAVE_ACL_GET_BRAND_NP 1	/* acl_get_brand_np() function */
#define HAVE_ACL_IS_TRIVIAL_NP 1	/* acl_is_trivial_np() function */
#define HAVE_ACL_STRIP_NP 1	/* acl_strip_np() function */
 ...
 */
#define HOST_ALIAS "amd64-unknown-freebsd12.0"		/* Output from config.guess (orig)	*/
#define HOST_SUB "amd64-unknown-freebsd12.0"			/* Output from config.sub (modified)	*/
#define HOST_CPU "amd64"			/* CPU part from HOST_SUB		*/
#define HOST_VENDOR "unknown"		/* VENDOR part from HOST_SUB		*/
#define HOST_OS "freebsd12.0"			/* CPU part from HOST_SUB		*/
